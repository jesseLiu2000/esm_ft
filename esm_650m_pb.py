...
training_args = TrainingArguments(
    output_dir=f"/scratch0/zx22/zijie/esm/results/650_{timestamp}",
    num_train_epochs=20,
    learning_rate=1e-03,
...
trainer.train()
save_path = os.path.join("/scratch0/zx22/zijie/esm/results/", f"best_model_esm2_t12_650M_probe/{timestamp}")
